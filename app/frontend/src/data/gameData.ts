...
const RAW_LEVELS: Level[] = [
  ...
  },
  {
    ...
    items: [
      { id: 'gold-hairpin', name: '金钗', icon: '✨', image: '/assets/level5-items.png', x: 77, y: 73, hitRadius: 4 },
      { id: 'hidden-bag', name: '藏赃布袋', icon: '👝', image: '/assets/level5-items.png', x: 12, y: 79, hitRadius: 4 },
      { id: 'slander-note', name: '诬陷字条', icon: '📝', image: '/assets/level5-items.png', x: 75, y: 58, hitRadius: 4 },
      { id: 'innocence-token', name: '令牌', icon: '🏅', image: '/assets/level5-items.png', x: 69, y: 56, hitRadius: 4 },
      { id: 'exorcism-paper', name: '驱邪符纸', icon: '📃', image: '/assets/level5-items.png', x: 13, y: 45, hitRadius: 4 },
      { id: 'copper-thimble', name: '顶针', icon: '⭕', image: '/assets/level5-items.png', x: 70, y: 79, hitRadius: 4 },
      { id: 'torn-kerchief', name: '破损绢帕', icon: '🎀', image: '/assets/level5-items.png', x: 44, y: 57, hitRadius: 4 },
      { id: 'wooden-comb', name: '木梳', icon: '〰️', image: '/assets/level5-items.png', x: 32, y: 80, hitRadius: 4 },
    ],
  },
  {
    id: 6,
    ...
    items: [
      { id: 'divorce-letter', name: '休书', icon: '📋', image: '/assets/level6-items.png', x: 50, y: 73, hitRadius: 4 },
      { id: 'beating-stick', name: '施暴木杖', icon: '🪵', image: '/assets/level6-items.png', x: 63, y: 78, hitRadius: 4 },
      { id: 'bully-contract', name: '恶霸约定书', icon: '📑', image: '/assets/level6-items.png', x: 52, y: 38, hitRadius: 4 },
      { id: 'fox-fur-charm', name: '狐毛护符', icon: '🦊', image: '/assets/level6-items.png', x: 56, y: 62, hitRadius: 4 },
      { id: 'bamboo-plea', name: '求救竹', icon: '🎋', image: '/assets/level6-items.png', x: 14, y: 70, hitRadius: 4 },
      { id: 'copper-candlestick', name: '铜烛台', icon: '🕯️', image: '/assets/level6-items.png', x: 45, y: 39, hitRadius: 4 },
      { id: 'broken-inkstone', name: '破损砚台', icon: '⬛', image: '/assets/level6-items.png', x: 22, y: 80, hitRadius: 4 },
      { id: 'hemp-ball', name: '麻线团', icon: '🧶', image: '/assets/level6-items.png', x: 31, y: 75, hitRadius: 4 },
      { id: 'silver-bracelet', name: '银手镯', icon: '💍', image: '/assets/level6-items.png', x: 30, y: 84, hitRadius: 4 },
      { id: 'wooden-abacus', name: '木算盘', icon: '🧮', image: '/assets/level6-items.png', x: 55, y: 80, hitRadius: 4 },
    ],
  },
  {
    id: 7,
    ...
    items: [
      { id: 'bully-waist-token', name: '恶霸腰牌', icon: '🏷️', x: 59, y: 54, hitRadius: 4 },
      { id: 'thug-blade', name: '打手钢刀', icon: '🗡️', x: 80, y: 71, hitRadius: 4 },
      { id: 'lewd-fan', name: '轻薄绢扇', icon: '🪭', x: 59, y: 42, hitRadius: 4 },
      { id: 'rescue-gong', name: '求救铜锣', icon: '🥁', x: 87, y: 31, hitRadius: 4 },
      { id: 'peach-staff', name: '镇邪桃木杖', icon: '🪵', x: 38, y: 52, hitRadius: 4 },
      { id: 'copper-bell-7', name: '铜铃铛', icon: '🔔', x: 64, y: 54, hitRadius: 3 },
      { id: 'broken-hat', name: '破损草帽', icon: '👒', x: 17, y: 71, hitRadius: 4 },
      { id: 'silver-pin-7', name: '银簪', icon: '📍', x: 49, y: 76, hitRadius: 3 },
      { id: 'wooden-bowl', name: '木碗', icon: '🥣', x: 86, y: 64, hitRadius: 4 },
      { id: 'cloth-boot', name: '布靴', icon: '👢', x: 91, y: 79, hitRadius: 4 },
      { id: 'bamboo-basket', name: '竹篮', icon: '🧺', x: 14, y: 69, hitRadius: 4 },
      { id: 'copper-key', name: '铜钥匙', icon: '🔑', x: 52, y: 74, hitRadius: 3 },
    ],
  },
  {
    id: 8,
    ...
    items: [
      { id: 'millennium-petal', name: '千年花片', icon: '🌸', x: 11, y: 54, hitRadius: 4 },
      { id: 'spirit-dew', name: '灵泉露滴', icon: '💧', x: 16, y: 65, hitRadius: 4 },
      { id: 'fox-spirit-stone', name: '狐族灵石', icon: '💎', x: 81, y: 67, hitRadius: 4 },
      { id: 'ghost-bone', name: '鬼母骨片', icon: '🦴', x: 88, y: 45, hitRadius: 3 },
      { id: 'awakening-paper', name: '觉醒咒纸', icon: '📃', x: 30, y: 49, hitRadius: 4 },
      { id: 'spirit-seed', name: '灵草种子', icon: '🌱', x: 10, y: 78, hitRadius: 3 },
      { id: 'jade-button', name: '玉扣', icon: '⚪', x: 24, y: 79, hitRadius: 3 },
      { id: 'copper-token-8', name: '铜制令牌', icon: '🏷️', x: 92, y: 63, hitRadius: 4 },
      { id: 'fox-fur-8', name: '狐毛', icon: '🦊', x: 39, y: 58, hitRadius: 3 },
      { id: 'rune-stone', name: '符文石', icon: '🪨', x: 80, y: 72, hitRadius: 4 },
      { id: 'glass-bead', name: '琉璃珠', icon: '🔮', x: 65, y: 82, hitRadius: 3 },
      { id: 'silver-bell-8', name: '银质小铃', icon: '🔔', x: 87, y: 14, hitRadius: 3 },
    ],
  },
  {
    id: 9,
    ...
    items: [
      { id: 'whip', name: '恶奴皮鞭', icon: '🪢', x: 60, y: 52, hitRadius: 4 },
      { id: 'fox-talisman', name: '狐族咒符', icon: '📃', x: 44, y: 49, hitRadius: 4 },
      { id: 'stolen-silver', name: '被抢银饰', icon: '💍', x: 12, y: 64, hitRadius: 3 },
      { id: 'servant-token', name: '恶奴腰牌', icon: '🏷️', x: 58, y: 48, hitRadius: 4 },
      { id: 'spirit-grass', name: '灵草', icon: '🌿', x: 87, y: 63, hitRadius: 3 },
      { id: 'firewood', name: '木柴', icon: '🪵', x: 11, y: 72, hitRadius: 4 },
      { id: 'clay-bowl', name: '陶碗', icon: '🥣', x: 19, y: 69, hitRadius: 4 },
      { id: 'copper-pin-9', name: '铜钗', icon: '📍', x: 15, y: 64, hitRadius: 3 },
      { id: 'hemp-rope', name: '麻绳', icon: '🪢', x: 79, y: 68, hitRadius: 4 },
      { id: 'torn-cloth', name: '破布', icon: '🧷', x: 44, y: 73, hitRadius: 3 },
      { id: 'silver-ring', name: '银戒指', icon: '💍', x: 38, y: 77, hitRadius: 3 },
      { id: 'bamboo-slip', name: '竹片', icon: '🎋', x: 73, y: 68, hitRadius: 3 },
      { id: 'stone-inkstone', name: '石砚', icon: '⬛', x: 21, y: 82, hitRadius: 4 },
      { id: 'cloth-towel', name: '布巾', icon: '🧻', x: 49, y: 71, hitRadius: 3 },
      { id: 'iron-pliers', name: '铁钳', icon: '🔧', x: 54, y: 66, hitRadius: 3 },
    ],
  },
  {
    id: 10,
    ...
    items: [
      { id: 'fox-jade-final', name: '狐族玉佩', icon: '💎', x: 43, y: 46, hitRadius: 4 },
      { id: 'wang-fan', name: '王子服折扇', icon: '🪭', x: 54, y: 41, hitRadius: 4 },
      { id: 'wang-mother-pin', name: '王母金钗', icon: '✨', x: 82, y: 32, hitRadius: 3 },
      { id: 'bully-dagger', name: '恶霸匕首', icon: '🗡️', x: 70, y: 49, hitRadius: 4 },
      { id: 'ghost-jade', name: '鬼母玉佩', icon: '⚪', x: 41, y: 31, hitRadius: 3 },
      { id: 'copper-incense', name: '铜香炉', icon: '🕯️', x: 42, y: 52, hitRadius: 4 },
      { id: 'torn-painting', name: '破损字画', icon: '🖼️', x: 19, y: 27, hitRadius: 4 },
      { id: 'silver-cup', name: '银酒杯', icon: '🥂', x: 80, y: 58, hitRadius: 3 },
      { id: 'box-key', name: '木盒钥匙', icon: '🔑', x: 46, y: 61, hitRadius: 3 },
      { id: 'jade-pin-10', name: '玉簪', icon: '💚', x: 82, y: 47, hitRadius: 3 },
      { id: 'hemp-bag', name: '麻布袋', icon: '👝', x: 11, y: 73, hitRadius: 4 },
      { id: 'copper-candle-10', name: '铜烛台', icon: '🕯️', x: 77, y: 61, hitRadius: 3 },
      { id: 'bamboo-holder', name: '竹笔筒', icon: '🖊️', x: 84, y: 52, hitRadius: 4 },
      { id: 'silver-pin-10', name: '银钗', icon: '📍', x: 61, y: 28, hitRadius: 3 },
